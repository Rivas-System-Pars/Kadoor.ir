                                                                ...
                                                                <div class="col-md-3 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="rounding_amount" class="form-control">
                                                                            ...
                                                                            <option data-value="100" value="100" {{ $product->rounding_amount == "100" ? 'selected' : '' }}>100 ريال</option>
                                                                            <option data-value="1000" value="1000" {{ $product->rounding_amount == "1000" ? 'selected' : '' }}>1000 ريال</option>
                                                                            <option data-value="10000" value="10000" {{ $product->rounding_amount == "10000" ? 'selected' : '' }}>10000 ريال</option>
                                                                            <option data-value="100000" value="100000" {{ $product->rounding_amount == "100000" ? 'selected' : '' }}>100000 ريال</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
