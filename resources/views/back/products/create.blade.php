                                                        ...
                                                        <div class="form-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3 col-12 physical-item">
                                                                    <div class="form-group">
                                                                        <label>واحد</label>
                                                                        <input type="text" class="form-control" name="unit" value="{{ $copy_product ? $copy_product->unit : '' }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3 col-12 physical-item">
                                                                    <div class="form-group">
                                                                        <label>کد</label>
                                                                        <input type="text" class="form-control" name="code" value="{{ $copy_product ? $copy_product->code : '' }}">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-3 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="currency_id" class="form-control">
                                                                            <option data-amount="1" data-title="تومان" value="">ريال (پیش فرض)</option>
                                                                ...
                                                                <div class="col-md-3 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="rounding_amount" class="form-control">
                                                                            ...
                                                                            <option data-value="100" value="100" {{ $copy_product && $copy_product->rounding_amount == "100" ? 'selected' : '' }}>100 ريال</option>
                                                                            <option data-value="1000" value="1000" {{ $copy_product && $copy_product->rounding_amount == "1000" ? 'selected' : '' }}>1000 ريال</option>
                                                                            <option data-value="10000" value="10000" {{ $copy_product && $copy_product->rounding_amount == "10000" ? 'selected' : '' }}>10000 ريال</option>
                                                                            <option data-value="100000" value="100000" {{ $copy_product && $copy_product->rounding_amount == "100000" ? 'selected' : '' }}>100000 ريال</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
