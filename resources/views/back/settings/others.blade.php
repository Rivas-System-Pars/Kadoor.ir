                                            ...
                                            <div class="col-md-3 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="default_currency_id" class="form-control">
                                                        <option value="">ريال (پیش فرض)</option>
                                            ...
                                            <div class="col-md-3 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="default_rounding_amount" class="form-control">
                                                        ...
                                                        <option value="100" {{ option('default_rounding_amount') == 100 ? 'selected' : '' }}>100 ريال</option>
                                                        <option value="1000" {{ option('default_rounding_amount') == 1000 ? 'selected' : '' }}>1000 ريال</option>
                                                        <option value="10000" {{ option('default_rounding_amount') == 10000 ? 'selected' : '' }}>10000 ريال</option>
                                                        <option value="100000" {{ option('default_rounding_amount') == 100000 ? 'selected' : '' }}>100000 ريال</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
