        ...
        <div class="product-card-body">
            ...
            <div class="price-index-h">
                <div class="product-prices-div">
                    ...
                    <div class="product-prices-div">
                        <span
                            class="product-price">{{ $product->getLowestPrice() ? ' قیمت فروش :'.$product->getLowestPrice()  : ' قیمت فروش : -' }}</span>
                        <span
                            class="product-price">{{ $product->Consumer_price ? ' قیمت مصرف کننده :'.number_format($product->Consumer_price).' ریال ' : 'قیمت مصرف کننده : - '}}</span>
