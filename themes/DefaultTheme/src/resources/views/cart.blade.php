                                                                ...
                                                                <div class="row list-row">
                                                                    ...
                                                                    <div class="col-4 col-sm-3 col-md-2 d-flex justify-content-center">
                                                                        <div class="counter-box">
                                                                            ...
                                                                            <input class="quantity cart_quantity count" name="product-{{ $product->pivot->id }}" value="{{ $product->pivot->quantity }}" type="number" data-minus-class="mdi mdi-minus" data-remove-class="mdi mdi-delete-outline" dir="ltr" required>
                                                                    ...
                                                                    <div class="col-8 col-sm-9 col-md-3">
                                                                        <strong class="cart-product-price">{{ number_format($price_to_stock->discountPrice() * $product->pivot->quantity) }} <small>{{ option('default_currency_id',"ریال") }}</small></strong>

                                                                        @if($price_to_stock->discount)
                                                                            <del class="text-danger old-cart-product-price">{{ number_format($price_to_stock->tomanPrice() * $product->pivot->quantity) }} <small>{{ option('default_currency_id',"ریال") }}</small></del>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            @endforeach
