...
class Product extends Model
{
    ...
    public function addableToCart()
    {
        ...
        if ($this->price_type == "multiple-price" && !$this->prices()->first()) {
            return false;
        }
    ...
    public function getLowestPrice($numeric = false)
    {
        ...
        if ($price) {
            return $numeric ? $price->discountPrice() : number_format($price->discountPrice()) . ' '.option('default_currency_id',"ریال");
        }
	...
	public function scopeActiveShow($q)
    {
